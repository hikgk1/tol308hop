...
init: function() {
    entityManager.displayNpc(this.npcList.mainChar, 208, 208, true);
    entityManager.displayNpc(this.npcList.npc1, 208, 240, false);
    this.moveNpc(1, 0);
},

displayNpc : function (spArr, cx, cy, mainChar) {
